    ...
    run: async(client, interaction, args) => {
        ...
        collector.on('collect', (i) => {
            ...
            if (i.customId == "x") {
                ...
                interaction.editReply({ content: "> ❌ **All Bot Protection Settings Is Off**", embeds: [], components: [], ephemeral: true })
            } else if (i.customId == "full") {
                db.set(`AntiLinksArray_${interaction.guild.id}`, { data: ['https', 'http', 'www', 'discord.gg'] });
                db.set(`AntiSwearArray_${interaction.guild.id}`, { data: ['fuck', 'pussy', 'نيك', 'كس'] });
                ...
                interaction.editReply({ content: "> 🔓 **All Bot Protection Settings Is On**", embeds: [], components: [], ephemeral: true })
                ...
                interaction.editReply({ content: "> 🔒 **NIRO Protection is active**", embeds: [], components: [], ephemeral: true })
            }
        })
    },
};