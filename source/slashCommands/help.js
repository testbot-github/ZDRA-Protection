...
module.exports = {
    ...
    run: async(client, interaction, args) => {
        ...
        collector.on('collect', async i => {
            ...
            if (i.customId == 'pro') {
                ...
                let row2 = new MessageActionRow()
                    .addComponents(btn, btn2, btn3, btn4);
                await interaction.editReply({ embeds: [embed2], components: [row2], ephemeral: true });
        ...
        collector.on('end', i => interaction.editReply({ content: '> :x: **Collector Time Out**', embeds: [], components: [], ephemeral: true }));
    },
};