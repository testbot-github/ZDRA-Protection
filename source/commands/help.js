...
module.exports = {
    ...
    run: async(client, message, args, prefix, lang, admins, db, MessageEmbed) => {
        ...
        var collector = m.createMessageComponentCollector({ filter: iFilter, time: 3600000 })
        collector.on('collect', async i => {
            ...
            if (i.customId == 'pro') {
                const embed2 = new MessageEmbed()
                    ...
                    .addField(`${prefix}set-limit RoleCreate <number>`, `Set Limite Role Create`, true)
                    .addField(`${prefix}set-limit RoleDelete <number>`, `Set Limite Role Delete`, true)
                    .addField(`${prefix}set-limit ChannelCreate <number>`, `Set Limite Channel Create`, true)
                    .addField(`${prefix}set-limit ChannelDelete <number>`, `Set Limite Channel Delete`, true)
                    .addField(`${prefix}set-limit MembersBan <number>`, `Set Limite Members Ban`, true)
                    .addField(`${prefix}set-limit MemebrsKick <number>`, `Set Limite Members Kick`, true)
                    .addField(`${prefix}toggle-limit RoleCreate <on/off>`, `Set Limite Role Create`, true)
                    .addField(`${prefix}toggle-limit RoleDelete <on/off>`, `Set Limite Role Delete`, true)
                    .addField(`${prefix}toggle-limit ChannelCreate <on/off>`, `Set Limite Channel Create`, true)
                    .addField(`${prefix}toggle-limit ChannelDelete <on/off>`, `Set Limite Channel Delete`, true)
                    .addField(`${prefix}toggle-limit MembersBan <on/off>`, `Set Limite Members Ban`, true)
                    .addField(`${prefix}toggle-limit MemebrsKick <on/off> `, `Set Limite Members Kick`, true)
                ...
                let row2 = new MessageActionRow()
                    .addComponents(btn, btn2, btn3, btn4);
                await m.edit({ embeds: [embed2], components: [row2], ephemeral: true });
                ...
                const embed2 = new MessageEmbed()
                    ...
                    .addField(`${prefix}files-only `, `Make The Channel To Send Files Only`, true)
                    ...
                    .addField(`${prefix}show `, `Show Channel To Allow Any One To See It`, true)
                    ...
                    .addField(`${prefix}setting lang <en/ar>`, `To Set The Bot Lang`, true)
                    .addField(`${prefix}setting prefix <prefix>`, `To Set The Bot Prefix`, true)
                    .addField(`${prefix}setting admins <id>`, `To Add An Admin To The Allowed Admins`, true)
                let btn = new MessageButton()
                    .setCustomId('pro')
                    .setStyle("DANGER")
                    .setLabel('🔒 Protection');
                ...
                const embed2 = new MessageEmbed()
                    ...
                    Discord Server: https://discord.gg/developer-support`, false)
                    .addField(`Cyber: `,
                        `- Made:
                    ...
                    Discord Server: https://discord.gg/tFSACgnS8Q`, true)
                let btn = new MessageButton()
                    .setCustomId('pro')
                    .setStyle("DANGER")
                    .setLabel('🔒 Protection');
        ...
        collector.on('end', i => m.edit({ content: '> :x: **Collector Time Out**', embeds: [], components: [], ephemeral: true }).catch(err => { return }));
    }
};